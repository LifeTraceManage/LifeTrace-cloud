//! Application-level API rate limiting.
//!
//! Authentication endpoints already have stricter credential-aware limits.
//! This layer is the broad abuse-control baseline for the remaining
