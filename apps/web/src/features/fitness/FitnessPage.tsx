...
export function FitnessPage() {
  ...
  return <div className="page-shell"><PageHeader title="健身" action={<Button onClick={() => setShowNew(true)}><Plus size={16}/>记录训练</Button>} />
